    ...
    >
      ...
      <el-form v-if="showLogn" ref="loginform" :model="user">
        <el-form-item label="账号" prop="username">
          <el-input placeholder="请输入用户名/手机号码" v-model="user.username"></el-input>
        </el-form-item>
        ...
        <el-form-item>
          <div style="display:flex;justify-content:space-between">
            ...
            >记住密码</el-checkbox>
            <span @click="goReset" style="color:#2799F7;font-size:12px;cursor:pointer">忘记密码？</span>
          </div>
        </el-form-item>
        <el-form-item>
          <div>
        ...
        <el-form-item>
          <el-button style="width:100%;font-size:18px;" @click="goRegister">立即注册</el-button>
        </el-form-item>
      </el-form>
      <!-- 登录 -->
      <!-- 注册 -->
      <el-form v-if="showRegister" ref="resetForm" :model="user">
        ...
        <el-form-item>
          <el-input placeholder="请输入验证码" style="width:63%;" v-model="user.code"></el-input>
        ...
        <div class="ct" @click="goLogin">
          <a style="color:#B3B3B3;font-size:19px;font-weight:500;cursor:pointer">我已经有账号了，立即登录！</a>
        </div>
      </el-form>
      <!-- 注册 -->
      <!-- 忘记密码 -->
      <el-form v-if="showReset" ref="form" :model="user">
        ...
        <el-form-item>
          <el-button type="primary" @click="goLogin" style="width:100%;font-size:18px;">登录</el-button>
        </el-form-item>
      </el-form>
      <!-- 忘记密码 -->
    </el-dialog>
